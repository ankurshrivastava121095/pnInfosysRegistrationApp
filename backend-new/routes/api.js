...
router.get('/interview-question-course/:id', middleWare, InterviewQuestionCourseController.fetchSingle)
...
router.get('/interview-question', InterviewQuestionController.fetchAll)
router.get('/interview-question-selected-course/:id', InterviewQuestionController.fetchByCourseId)
router.get('/interview-question/:id', middleWare, InterviewQuestionController.fetchSingle)
