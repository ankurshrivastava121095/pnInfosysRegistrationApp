...
import { Avatar, Badge, Box, Button, IconButton, InputAdornment, styled, TextField, Tooltip, Typography } from '@mui/material'
...
const AdminHeader = () => {
    ...
    const menus = [
        { menu: 'Dashboard', icon: <DashboardIcon />, route: 'dashboard' },
