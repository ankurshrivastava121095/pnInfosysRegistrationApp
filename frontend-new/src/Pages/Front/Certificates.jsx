                    ...
                    <div className="col-md-12">
                        <div style={{ minHeight: '70vh' }} className='d-flex align-items-center justify-content-center'>
                            <div className='w-100 rounded'>
                                <div className="row">
                                    <div className="col-md-3 d-flex align-items-center justify-content-center" style={{ background: 'rgb(0 113 187 / 57%)' }}>
                                        <Box sx={{ pb: 3, px: 4 }}>
                                                ...
                                                <div className="col-md-3 mt-3">
                                                    <Box sx={{ boxShadow: 5, p: 1, background: '#fff' }}>
                                                        ...
                                                        <Box sx={{ p: 1 }}>
                                                            ...
                                                            <Typography>Course: MERN Stack Development</Typography>
